# Generated by Django 3.2 on 2023-06-05 18:42
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('cooking_time', models.PositiveSmallIntegerField(help_text='Указать время приготовления', validators=[django.core.validators.MinValueValidator(1, message='Время менее 1 мин')], verbose_name='Время приготовления')),
            ],
            options={
                'verbose_name': 'Рецепт',
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.AutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('recipe', models.ForeignKey(help_text='Рецепт, из которого берутся ингридиенты', on_delete=django.db.models.deletion.CASCADE, related_name='shopping_cart', to='recipes.recipe', verbose_name='Рецепт')),
            ],
            options={
