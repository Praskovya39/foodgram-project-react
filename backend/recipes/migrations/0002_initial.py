...
class Migration(migrations.Migration):
    ...
    operations = [
        migrations.AddField(
            ...
            name='user',
            field=models.ForeignKey(help_text='Владелец корзины', on_delete=django.db.models.deletion.CASCADE, related_name='shopping_cart', to=settings.AUTH_USER_MODEL, verbose_name='Юзер'),
        ),
        migrations.AddField(
            model_name='recipe',
            name='author',
